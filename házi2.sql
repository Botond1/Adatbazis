...
CREATE TABLE [dbo].[Ugyfel](
	...
	[CIM] [nvarchar](255) MASKED WITH (Function = 'partial(2,"XXX",2)') NULL,
...
grant SELECT ON Ugyfel to admin

--lekerdezes maszkolva
execute As user = 'felhasznalo'
SELECT * FRom Ugyfel

--maszkolás nélkül lekérdezés
revert
SELECT * FRom Ugyfel
